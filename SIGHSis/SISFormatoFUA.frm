...
Begin VB.Form SisFuaVersion2 
   ...
   Begin TabDlg.SSTab TabFua 
      ...
      Tab(1).Control(6)=   "txtMedicoColegiatura"
      Tab(1).Control(7)=   "txtMedicoDni"
      Tab(1).Control(8)=   "txtMedicoEspecialidad"
      Tab(1).Control(9)=   "chkMedicoEgresado"
      Tab(1).Control(10)=   "txtMedicoRNE"
