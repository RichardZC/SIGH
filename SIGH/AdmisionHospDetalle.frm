...
Begin VB.Form AdmisionHospDetalle 
   ...
   Begin TabDlg.SSTab tabAdmision 
      ...
      Begin TabDlg.SSTab TabIngreso 
         ...
         Tab(1).Control(0)=   "ucTransferenciasDetalle1"
         Tab(1).Control(1)=   "Frame9"
         Tab(1).Control(2)=   "fraServicioActual"
         ...
         Tab(3).Control(0)=   "Enfermeras"
         Tab(3).Control(1)=   "Frame1"
         Tab(3).Control(2)=   "fraCPT"
         Tab(3).Control(3)=   "SSCheck1"
         Tab(3).Control(4)=   "UcPacientesSunasa1"
         ...
         Tab(4).Control(2)=   "ucDiagnosticoNacimiento"
