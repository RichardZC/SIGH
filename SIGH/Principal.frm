...
Begin VB.Form Principal 
   ...
   Begin Listbar.SSListBar SecurityListbar 
      ...
      IconsLargeCount =   43
      Image(1).Index  =   1
      Image(1).Picture=   "Principal.frx":318A4
      Image(1).Key    =   "AdmisionCE"
      Image(2).Index  =   2
      Image(2).Picture=   "Principal.frx":324F6
      Image(2).Key    =   "Paciente"
      Image(3).Index  =   3
      Image(3).Picture=   "Principal.frx":33148
      Image(3).Key    =   "AdmisionHospitalizacion"
      Image(4).Index  =   4
      Image(4).Picture=   "Principal.frx":33D9A
      Image(4).Key    =   "AdmisionConsultorioEmerg"
      Image(5).Index  =   5
      Image(5).Picture=   "Principal.frx":349EC
      Image(5).Key    =   "Programacion"
      Image(6).Index  =   6
      Image(6).Picture=   "Principal.frx":3563E
      Image(6).Key    =   "Medico"
      Image(7).Index  =   7
      Image(7).Picture=   "Principal.frx":36290
      Image(7).Key    =   "Turno"
      Image(8).Index  =   8
      Image(8).Picture=   "Principal.frx":36EE2
      Image(8).Key    =   "HistoriaClinica"
      Image(9).Index  =   9
      Image(9).Picture=   "Principal.frx":37B34
      Image(9).Key    =   "MovimientoHistoria"
      Image(10).Index =   10
      Image(10).Picture=   "Principal.frx":38786
      Image(10).Key   =   "SolicitudHistorias"
      Image(11).Index =   11
      Image(11).Picture=   "Principal.frx":393D8
      Image(11).Key   =   "Archivero"
      Image(12).Index =   12
      Image(12).Picture=   "Principal.frx":3AF2A
      Image(13).Index =   13
      Image(13).Picture=   "Principal.frx":3CA7C
      Image(13).Key   =   "Tarifario"
      Image(14).Index =   14
      Image(14).Picture=   "Principal.frx":3E5CE
      Image(15).Index =   15
      Image(15).Picture=   "Principal.frx":40120
      Image(15).Key   =   "Empleado"
      Image(16).Index =   16
      Image(16).Picture=   "Principal.frx":40D72
      Image(16).Key   =   "Servicios"
      Image(17).Index =   17
      Image(17).Picture=   "Principal.frx":419C4
      Image(17).Key   =   "Procedimientos"
      Image(18).Index =   18
      Image(18).Picture=   "Principal.frx":42616
      Image(18).Key   =   "Diagnosticos"
      Image(19).Index =   19
      Image(19).Picture=   "Principal.frx":43268
      Image(19).Key   =   "TiposFinanciamiento"
      Image(20).Index =   20
      Image(20).Picture=   "Principal.frx":43EBA
      Image(20).Key   =   "FuentesFinanciamiento"
      Image(21).Index =   21
      Image(21).Picture=   "Principal.frx":44B0C
      Image(21).Key   =   "EstablecimientosNoMinsa"
      Image(22).Index =   22
      Image(22).Picture=   "Principal.frx":4575E
      Image(22).Key   =   "Camas"
      Image(23).Index =   23
      Image(23).Picture=   "Principal.frx":463B0
      Image(23).Key   =   "AdmisionObservacion"
      Image(24).Index =   24
      Image(24).Picture=   "Principal.frx":47002
      Image(24).Key   =   "AtencionesCE"
      Image(25).Index =   25
      Image(25).Picture=   "Principal.frx":47C54
      Image(25).Key   =   "Interconsultas"
      Image(26).Index =   26
      Image(26).Picture=   "Principal.frx":488A6
      Image(27).Index =   27
      Image(27).Picture=   "Principal.frx":494F8
      Image(27).Key   =   "DiagnosticosPDF"
      Image(28).Index =   28
      Image(28).Picture=   "Principal.frx":4A14A
      Image(28).Key   =   "Roles"
      Image(29).Index =   29
      Image(29).Picture=   "Principal.frx":4AD9C
      Image(29).Key   =   "Imaginologia"
      Image(30).Index =   30
      Image(30).Picture=   "Principal.frx":4B9EE
      Image(30).Key   =   "PatologiaClinica"
      Image(31).Index =   31
      Image(31).Picture=   "Principal.frx":4C640
      Image(31).Key   =   "AnatomiaPatologica"
      Image(32).Index =   32
      Image(32).Picture=   "Principal.frx":4D292
      Image(32).Key   =   "CierreCaja"
      Image(33).Index =   33
      Image(33).Picture=   "Principal.frx":4DEE4
      Image(33).Key   =   "Cajeros"
      Image(34).Index =   34
      Image(34).Picture=   "Principal.frx":4EB36
      Image(34).Key   =   "Cajas"
      Image(35).Index =   35
      Image(35).Picture=   "Principal.frx":4F788
      Image(35).Key   =   "AperturaCaja"
      Image(36).Index =   36
      Image(36).Picture=   "Principal.frx":503DA
      Image(36).Key   =   "ComprobantePago"
      Image(37).Index =   37
      Image(37).Picture=   "Principal.frx":5102C
      Image(37).Key   =   "CartasGarantia"
      Image(38).Index =   38
      Image(38).Picture=   "Principal.frx":51C7E
      Image(38).Key   =   "CatalogoServicios"
      Image(39).Index =   39
      Image(39).Picture=   "Principal.frx":528D0
      Image(39).Key   =   "Planes"
      Image(40).Index =   40
      Image(40).Picture=   "Principal.frx":53522
      Image(40).Key   =   "CentroCostos"
      Image(41).Index =   41
      Image(41).Picture=   "Principal.frx":54174
      Image(41).Key   =   "Lote"
      Image(42).Index =   42
      Image(42).Picture=   "Principal.frx":54DC6
      Image(42).Key   =   "Cuadre"
      Image(43).Index =   43
      Image(43).Picture=   "Principal.frx":55A18
