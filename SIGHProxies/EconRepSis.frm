...
Begin VB.Form frmEconRepSIS 
   ...
   Begin TabDlg.SSTab SSTab 
      ...
      Tab(0).Control(1)=   "txtHC"
      Tab(0).Control(2)=   "txtAN"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "txtCA"
      Tab(0).Control(4)=   "Frame1"
      Tab(0).Control(5)=   "cmdBuscaCuentaPorApellidos"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "grdServicios"
      Tab(0).Control(7)=   "grdAtenciones"
      Tab(0).Control(8)=   "optTodos"
      Tab(0).Control(9)=   "optFechas"
      Tab(0).Control(10)=   "txtFechaInicio"
      Tab(0).Control(11)=   "txtFechaFin"
